...
def create_ui():
    ...
    with gr.Blocks(
        title="Multi-Website Text Analyzer",
        ...
        gr.HTML("""
            <div class="title-container">
                <h1 class="title">Multi-Website Text Analyzer</h1>
        ...
        with gr.Row(visible=False) as processing_indicator:
            gr.HTML("""
                <div class="processing-indicator">
                    ...
                    <div class="processing-indicator-text">Processing websites. Please wait...</div>
                </div>
            """)
        ...
        with gr.Column(elem_classes=["instructions-card"]):
            ...
            gr.HTML("""
            <ol style="list-style-type: decimal; padding-left: 1.5rem; line-height: 1.6; color: #577399;">
                ...
                <li><strong style="color: #495867;">Specify search terms</strong> separated by commas</li>
                ...
                <li><strong style="color: #495867;">View results</strong> in the table below</li>
            ...
            gr.HTML("""
            <div style="margin-top: 15px; padding: 10px; background-color: rgba(254, 95, 85, 0.1); border-radius: 5px; border-left: 3px solid #FE5F55;">
                <p style="margin: 0; color: #577399; font-style: italic;">Tip: For best results, provide specific search terms that are highly relevant to your analysis goals.</p>
            </div>
            """)
        ...
        gr.HTML("""
            <div class="footer">
                ...
                © 2025 Multi-Website Text Analyzer | Created with Gradio
            </div>
        """)
